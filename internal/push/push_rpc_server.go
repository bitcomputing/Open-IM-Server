...
func (r *RPCServer) RegisterLegacyDiscovery() {
...
func (r *RPCServer) PushMsg(ctx context.Context, pbData *pbPush.PushMsgReq) (*pbPush.PushMsgResp, error) {
...
// func (r *RPCServer) DelUserPushToken(ctx context.Context, req *pbPush.DelUserPushTokenReq) (*pbPush.DelUserPushTokenResp, error) {
