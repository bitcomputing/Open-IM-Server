...
func GetAllUsersUidHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetAllUsersUidRequest
		...
		l := user.NewGetAllUsersUidLogic(r.Context(), svcCtx)
		resp, err := l.GetAllUsersUid(&req)
		if err != nil {
