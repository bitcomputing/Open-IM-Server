...
func GetUsersInfoFromCacheHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetUsersInfoFromCacheRequest
		...
		l := user.NewGetUsersInfoFromCacheLogic(r.Context(), svcCtx)
		resp, err := l.GetUsersInfoFromCache(&req)
		if err != nil {
