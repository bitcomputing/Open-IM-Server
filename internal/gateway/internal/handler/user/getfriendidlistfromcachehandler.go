...
func GetFriendIDListFromCacheHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetFriendIDListFromCacheRequest
		...
		l := user.NewGetFriendIDListFromCacheLogic(r.Context(), svcCtx)
		resp, err := l.GetFriendIDListFromCache(&req)
		if err != nil {
