...
import (
	...
	"Open_IM/internal/gateway/internal/logic/supergroup"
...
func GetJoinedSuperGroupListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetJoinedSuperGroupListRequest
		...
		l := supergroup.NewGetJoinedSuperGroupListLogic(r.Context(), svcCtx)
		resp, err := l.GetJoinedSuperGroupList(&req)
		if err != nil {
