...
func GetSuperGroupsInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetSuperGroupsInfoRequest
		...
		l := supergroup.NewGetSuperGroupsInfoLogic(r.Context(), svcCtx)
		resp, err := l.GetSuperGroupsInfo(&req)
		if err != nil {
