...
func RespondGroupApplicationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RespondGroupApplicationRequest
		...
		l := group.NewRespondGroupApplicationLogic(r.Context(), svcCtx)
		resp, err := l.RespondGroupApplication(&req)
		if err != nil {
