...
func InviteUserToGroupsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InviteUserToGroupsRequest
		...
		l := group.NewInviteUserToGroupsLogic(r.Context(), svcCtx)
		resp, err := l.InviteUserToGroups(&req)
		if err != nil {
