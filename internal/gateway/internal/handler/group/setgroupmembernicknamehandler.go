...
func SetGroupMemberNicknameHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SetGroupMemberNicknameRequest
		...
		l := group.NewSetGroupMemberNicknameLogic(r.Context(), svcCtx)
		resp, err := l.SetGroupMemberNickname(&req)
		if err != nil {
