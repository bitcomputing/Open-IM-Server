...
func PullMsgBySeqListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PullMsgBySeqListRequest
		...
		l := message.NewPullMsgBySeqListLogic(r.Context(), svcCtx)
		resp, err := l.PullMsgBySeqList(&req)
		if err != nil {
