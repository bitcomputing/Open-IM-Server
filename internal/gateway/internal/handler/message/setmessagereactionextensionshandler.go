...
func SetMessageReactionExtensionsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SetMessageReactionExtensionsRequest
		...
		l := message.NewSetMessageReactionExtensionsLogic(r.Context(), svcCtx)
		resp, err := l.SetMessageReactionExtensions(&req)
		if err != nil {
