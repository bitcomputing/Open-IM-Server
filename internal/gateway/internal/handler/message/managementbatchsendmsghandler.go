...
func ManagementBatchSendMsgHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ManagementBatchSendMsgRequest
		...
		l := message.NewManagementBatchSendMsgLogic(r.Context(), svcCtx)
		resp, err := l.ManagementBatchSendMsg(&req)
		if err != nil {
