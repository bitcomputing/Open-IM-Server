...
func ManagementSendMsgHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ManagementSendMsgRequest
		...
		l := message.NewManagementSendMsgLogic(r.Context(), svcCtx)
		resp, err := l.ManagementSendMsg(&req)
		if err != nil {
