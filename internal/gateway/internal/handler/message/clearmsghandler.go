...
func ClearMsgHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ClearMsgRequest
		...
		l := message.NewClearMsgLogic(r.Context(), svcCtx)
		resp, err := l.ClearMsg(&req)
		if err != nil {
