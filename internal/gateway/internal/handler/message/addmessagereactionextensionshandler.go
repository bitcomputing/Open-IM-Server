...
func AddMessageReactionExtensionsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddMessageReactionExtensionsRequest
		...
		l := message.NewAddMessageReactionExtensionsLogic(r.Context(), svcCtx)
		resp, err := l.AddMessageReactionExtensions(&req)
		if err != nil {
