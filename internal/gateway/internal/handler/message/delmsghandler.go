...
func DelMsgHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DelMsgRequest
		...
		l := message.NewDelMsgLogic(r.Context(), svcCtx)
		resp, err := l.DelMsg(&req)
		if err != nil {
