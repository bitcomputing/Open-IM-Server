...
func RemoveFriendBlacklistHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RemoveFriendBlacklistRequest
		...
		l := friend.NewRemoveFriendBlacklistLogic(r.Context(), svcCtx)
		resp, err := l.RemoveFriendBlacklist(&req)
		if err != nil {
