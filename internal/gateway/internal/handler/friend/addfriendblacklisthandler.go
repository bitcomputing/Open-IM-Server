...
func AddFriendBlacklistHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddFriendBlacklistRequest
		...
		l := friend.NewAddFriendBlacklistLogic(r.Context(), svcCtx)
		resp, err := l.AddFriendBlacklist(&req)
		if err != nil {
