...
func GetFriendBlacklistHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetFriendBlacklistRequest
		...
		l := friend.NewGetFriendBlacklistLogic(r.Context(), svcCtx)
		resp, err := l.GetFriendBlacklist(&req)
		if err != nil {
