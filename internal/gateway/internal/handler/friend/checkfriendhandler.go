...
func CheckFriendHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CheckFriendRequest
		...
		l := friend.NewCheckFriendLogic(r.Context(), svcCtx)
		resp, err := l.CheckFriend(&req)
		if err != nil {
