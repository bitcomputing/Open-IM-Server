...
func GetSelfFriendApplyListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetSelfFriendApplyListRequest
		...
		l := friend.NewGetSelfFriendApplyListLogic(r.Context(), svcCtx)
		resp, err := l.GetSelfFriendApplyList(&req)
		if err != nil {
