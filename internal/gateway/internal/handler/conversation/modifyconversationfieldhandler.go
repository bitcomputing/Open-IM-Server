...
func ModifyConversationFieldHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ModifyConversationFieldRequest
		...
		resp, err := l.ModifyConversationField(&req)
		if err != nil {
