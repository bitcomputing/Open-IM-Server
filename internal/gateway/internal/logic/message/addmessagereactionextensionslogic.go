...
func (l *AddMessageReactionExtensionsLogic) AddMessageReactionExtensions(req *types.AddMessageReactionExtensionsRequest) (*types.AddMessageReactionExtensionsResponse, error) {
