...
func (l *DeleteMessageReactionExtensionsLogic) DeleteMessageReactionExtensions(req *types.DeleteMessageReactionExtensionsRequest) (*types.DeleteMessageReactionExtensionsResponse, error) {
