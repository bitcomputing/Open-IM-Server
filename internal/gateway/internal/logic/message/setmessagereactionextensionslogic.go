...
func (l *SetMessageReactionExtensionsLogic) SetMessageReactionExtensions(req *types.SetMessageReactionExtensionsRequest) (*types.SetMessageReactionExtensionsResponse, error) {
