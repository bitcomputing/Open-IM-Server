...
type GetUsersInfoFromCacheLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewGetUsersInfoFromCacheLogic(ctx context.Context, svcCtx *svc.ServiceContext) *GetUsersInfoFromCacheLogic {
	return &GetUsersInfoFromCacheLogic{
...
func (l *GetUsersInfoFromCacheLogic) GetUsersInfoFromCache(req *types.GetUsersInfoFromCacheRequest) (resp *types.GetUsersInfoFromCacheResponse, err error) {
	...
	return &types.GetUsersInfoFromCacheResponse{
