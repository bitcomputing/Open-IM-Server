...
func (l *GetRecvGroupApplicationListLogic) GetRecvGroupApplicationList(req *types.GetRecvGroupApplicationListRequest) (resp *types.GetRecvGroupApplicationListResponse, err error) {
	...
	rpcReq := &group.GetGroupApplicationListReq{}
	...
	if err != nil {
		logger.Error(rpcReq.OperationID, "GetGroupApplicationList failed ", err.Error(), rpcReq.String())
		return nil, errors.InternalError.WriteMessage(err.Error())
	}

	return &types.GetRecvGroupApplicationListResponse{
