...
type InviteUserToGroupsLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewInviteUserToGroupsLogic(ctx context.Context, svcCtx *svc.ServiceContext) *InviteUserToGroupsLogic {
	return &InviteUserToGroupsLogic{
...
func (l *InviteUserToGroupsLogic) InviteUserToGroups(req *types.InviteUserToGroupsRequest) (*types.InviteUserToGroupsResponse, error) {
	...
	rpcReq := &group.InviteUserToGroupsReq{}
	...
	rpcResp, err := l.svcCtx.GroupClient.InviteUserToGroups(l.ctx, rpcReq)
	if err != nil {
		logger.Error(rpcReq.OperationID, "InviteUserToGroup failed ", err.Error(), rpcReq.String())
		return nil, errors.InternalError.WriteMessage(err.Error())
	}

	return &types.InviteUserToGroupsResponse{
