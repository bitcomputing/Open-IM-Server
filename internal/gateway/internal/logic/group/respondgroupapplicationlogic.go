...
type RespondGroupApplicationLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewRespondGroupApplicationLogic(ctx context.Context, svcCtx *svc.ServiceContext) *RespondGroupApplicationLogic {
	return &RespondGroupApplicationLogic{
...
func (l *RespondGroupApplicationLogic) RespondGroupApplication(req *types.RespondGroupApplicationRequest) (resp *types.RespondGroupApplicationResponse, err error) {
	...
	rpcReq := &group.GroupApplicationResponseReq{}
	...
	rpcResp, err := l.svcCtx.GroupClient.GroupApplicationResponse(l.ctx, rpcReq)
	if err != nil {
		logger.Error(rpcReq.OperationID, "GroupApplicationResponse failed ", rpcReq.String())
		return nil, errors.InternalError.WriteMessage(err.Error())
	}

	return &types.RespondGroupApplicationResponse{
